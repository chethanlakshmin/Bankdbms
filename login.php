...
<body style="background: url(images/tom.jpg);background-size: 100%">
<h1 class="alert alert-success rounded-0"><?php echo MCB ; ?><small class="float-right text-muted" style="font-size: 12pt;"></small></h1>
<br>
<?php echo $error ?>
<br>
<div id="accordion" role="tablist" class="w-25 float-right shadowBlack" style="margin-right: 222px">
	<br><h4 class="text-center text-black"> Please login </h4>
  <div class="card rounded-0">
    ...
    <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
      <div class="card-body">
       <form method="POST">
       	<input type="email" value="pavan1@gmail.com" name="email" class="form-control" required placeholder="Enter Email">
       	<input type="password" name="password" value="pavan1" class="form-control" required placeholder="Enter Password">
  ...
  <div class="card rounded-0">
    ...
    <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
      <div class="card-body">
         <form method="POST">
       	<input type="email" value="chethan@manager.com" name="email" class="form-control" required placeholder="Enter Email">
       	<input type="password" name="password" value="chethan" class="form-control" required placeholder="Enter Password">
  ...
  <div class="card rounded-0">
    ...
    <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
      <div class="card-body">
        <form method="POST">
       	<input type="email" value="kamalesh@cashier.com" name="email" class="form-control" required placeholder="Enter Email">
       	<input type="password" name="password" value="kamalesh" class="form-control" required placeholder="Enter Password">
